...
public class LBFGSOldMinimizer
{
	...
	/** This subroutine solves the unconstrained minimization problem
	  ...
	  *		</ul>
	  *
	  *	@throws LBFGSOldMinimizer.ExceptionWithIflag 
	  */
	...
	public static void lbfgs ( int n , int m , double[] x , double f , double[] g , boolean diagco , double[] diag , int[] iprint , double eps , double xtol , int[] iflag ) throws ExceptionWithIflag
	{
		...
		while ( true )
		{
			...
			LBFGSOldMcsrch.mcsrch ( n , x , f , g , w , ispt + point * n , stp , ftol , xtol , maxfev , info , nfev , diag );
